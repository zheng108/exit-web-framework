<div id="create_form" class="form_widget">
	<form id="user_form" action="account/user/insert" method="post">
	    ...
	    <div class="column">
	        ...
	        <div class="field">
	            <input type="password" id="password" name="password" class="text_input_big" size="25" />
	        </div>
	        <label for="configPassword">
				确认密码:
	        </label>
	        <div class="field">
	            <input type="password" id="configPassword" name="configPassword" class="text_input_big" size="25" />
	        </div>
	    </div>
	    <div class="column">
	        <label for="email">
	...
	<div class="clear">
		...
		<a href="javascript:$.submitMaskForm('#user_form',{maskEl:'#create_user',target:'#main_content',resetForm:true});" title="保存信息"><span class="button right">保 存</span></a>
	</div>
</div>