...
create table tb_account_user (id varchar(32) not null, login_name varchar(255), password varchar(255), pinyin_code varchar(255), real_name varchar(255), state integer, wubi_code varchar(255), primary key (id))
